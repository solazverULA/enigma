...
export class MainPage {
  ...
  { 
    ...
    console.log(this.abcStatic);

    /*
    var salida = [];

    while(this.abcStatic.length > 0){ 
      var index = Math.floor(Math.random() *this.abcStatic.length-1);
      var salida = salida.concat(this.abcStatic.splice(index,1));
    }
